package com.example.himanshu.textract;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE){
            ...
            if (requestCode == RESULT_OK){
                ...
                my_image.setImageURI(resultUri);
                //croped image which can display(preview.setImageURI(resultUri);)

                BitmapDrawable bitmapDrawable = (BitmapDrawable) my_image.getDrawable();
